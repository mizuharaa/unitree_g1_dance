...
export interface SystemStatus {
  ...
  jobs?: Array<{ name: string; iteration?: number; max_iteration?: number; mean_reward?: number; mean_episode_length?: number; wandb_url?: string; progress?: number; eta_s?: number; elapsed_s?: number; iteration_time_s?: number; total_eta_s?: number; stage?: number; total_stages?: number }>
